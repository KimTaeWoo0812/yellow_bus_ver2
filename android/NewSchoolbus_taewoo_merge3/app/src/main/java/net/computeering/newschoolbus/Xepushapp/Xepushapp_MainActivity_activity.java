...
public class Xepushapp_MainActivity_activity extends Activity {
    ...
    private BroadcastReceiver completeReceiver = new BroadcastReceiver(){
        ...
        public void onReceive(Context context, Intent intent) {
            Toast.makeText(getApplicationContext(), R.string.download_com, Toast.LENGTH_LONG).show();
        }
    };
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        Log.i("###wep테스트1","onActivityResult1");
        if(requestCode == 333) {
            Log.i("###wep테스트1","3331");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.xepushapp_activity_main_activity);
        context = getApplicationContext();
        intent_s = new Intent(this, Xepushapp_Setting.class);
        intent33 = new Intent(this, Xepushapp_Sendserver.class);
        ...
        if (checkPlayServices()) {
            ...
            Intent intent = new Intent(this, Xepushapp_RegistrationIntentService.class);
            startService(intent);
        }
        ...
        mWebView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimetype, long contentLength) {
                ...
                if (handleDownload(Xepushapp_MainActivity_activity.this, url, fileName, mimetype)) {
                    Toast.makeText(getApplicationContext(), R.string.download_start, Toast.LENGTH_LONG).show();
                } else {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if (!url.matches(".*" + URL_Check + ".*")){
                ...
                if(checknetwork.equals("WIFI")){
                    ...
                    new AlertDialog.Builder(Xepushapp_MainActivity_activity.this)
    ...
    public class myWebChromeClient extends WebChromeClient {
        ...
        {
            popup=true;
            childView = new WebView(Xepushapp_MainActivity_activity.this);
        ...
        public void callAndroid_reg(final String memb, final String nick_n, final String change_a) {
            ...
            handler.post(new Runnable() {
                public void run() {
                    ...
                    Toast.makeText(getApplicationContext(), R.string.syn, Toast.LENGTH_LONG).show();
                    Toast.makeText(getApplicationContext(), "어플리케이션을 재시작합니다..",Toast.LENGTH_LONG).show();
                    ...
                    SignupActivity_pref.put(CustomPreferences.AUTOLOGIN_prevalue, "FALSE");
                    SignupActivity_pref.put(CustomPreferences.AMIFIRST_prefvalue, "FALSE");

                    Xepushapp_RestartApp.doRestart(getApplicationContext());
                }
            });
        }
    }
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton(R.string.yes, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                //Stop the activity
                                Xepushapp_MainActivity_activity.this.finish();
                            }
