 ...
 *
 */
public class Xepushapp_MainActivity extends Fragment implements View.OnClickListener {
    ...
    private BroadcastReceiver completeReceiver = new BroadcastReceiver(){
        ...
        public void onReceive(Context context, Intent intent) {
            Toast.makeText(getActivity().getApplicationContext(), R.string.download_com, Toast.LENGTH_LONG).show();
        }
    };


    public Xepushapp_MainActivity() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View xepushappview = inflater.inflate(R.layout.xepushapp_activity_main, container, false );

        context = getActivity().getApplicationContext();
        intent_s = new Intent(getActivity(), Xepushapp_Setting.class);
        intent33 = new Intent(getActivity(), Xepushapp_Sendserver.class);

        URL_home = Xepushapp_QuickstartPreferences.URL_home;
        socialxe2015 = Xepushapp_QuickstartPreferences.socialxe2015;
        socialxe = Xepushapp_QuickstartPreferences.socialxe;
        socialserver = Xepushapp_QuickstartPreferences.socialserver;
        my_domain_is_socialserver = Xepushapp_QuickstartPreferences.my_domain_is_socialserver;
        ...
        mRegistrationBroadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                boolean sentToken = sharedPreferences.getBoolean(Xepushapp_QuickstartPreferences.SENT_TOKEN_TO_SERVER, false);
            }
        };

        Log.i("###checkPlayServices ",""+checkPlayServices());
        if (checkPlayServices()) {
            Log.i("###checkPlayServices ","들어옴");
            // Start IntentService to register this application with GCM.
            Intent intent = new Intent(getActivity(), Xepushapp_RegistrationIntentService.class);
        ...
        btnBack = (ImageButton) xepushappview.findViewById(R.id.btnback);
        btnBack.setOnTouchListener(btnTouchListener);
        btnForward = (ImageButton) xepushappview.findViewById(R.id.btnforward);
        btnForward.setOnTouchListener(btnTouchListener);
        Gohome = (ImageButton) xepushappview.findViewById(R.id.gohome);
        Gohome.setOnTouchListener(btnTouchListener);
        Refresh = (ImageButton) xepushappview.findViewById(R.id.btnrefresh);
        Refresh.setOnTouchListener(btnTouchListener);
        Login = (ImageButton) xepushappview.findViewById(R.id.btnlogin);
        Login.setOnTouchListener(btnTouchListener);
        Setting = (ImageButton) xepushappview.findViewById(R.id.setting);
        Setting.setOnTouchListener(btnTouchListener);
        Finish = (ImageButton) xepushappview.findViewById(R.id.finish);
        Finish.setOnTouchListener(btnTouchListener);
        mWebView = (WebView) xepushappview.findViewById(R.id.webview);
        mLoadingProgressBar = (ProgressBar) xepushappview.findViewById(R.id.progressbar_Horizontal);
        customViewContainer = (FrameLayout) xepushappview.findViewById(R.id.customViewContainer);
        //bottomlayout = (RelativeLayout) xepushappview.findViewById(R.id.bottomlayout);
        ...
        webSettings.setDatabasePath(getActivity().getFilesDir() + "/database/");

        webSettings.setAppCacheEnabled(true);
        webSettings.setAppCacheMaxSize(1024 * 1024 * 8);
        webSettings.setAppCachePath(getActivity().getFilesDir() + "/cache/");
        ...
        mWebView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimetype, long contentLength) {
                ...
                if (handleDownload(getActivity(), url, fileName, mimetype)) {
                    Toast.makeText(getActivity().getApplicationContext(), R.string.download_start, Toast.LENGTH_LONG).show();
                } else {
...
//    }
    ...
    public void onResume() {
        ...
        getActivity().registerReceiver(completeReceiver, completeFilter);
        ...
        if(TextUtils.isEmpty(urlget)) {
            ...
            if (install) {
                sort = getActivity().getIntent().getStringExtra("sort");
                if (TextUtils.isEmpty(sort)) {
                    url_final = URL_home;
                } else {
                    address = getActivity().getIntent().getStringExtra("address");
                    if (sort.equals("msg")) {
                ...
                url_final = URL_home + "index.php?mid=applogin";
            }
    ...
    @SuppressLint("NewApi")
    public static boolean handleDownload(final Context context, final String fromUrl, final String toFilename,String mimetype) {
    ...
    private class myWebViewClient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if (!url.matches(".*" + URL_Check + ".*")){
                ...
                Log.i(TAG, "urllll:" + url);
                finall_url = getDownUrl(url);
                Log.i(TAG, "finall_url:" + finall_url);

                String checknetwork = checknet();
                Log.i(TAG, "checknetwork:" + checknetwork);
    ...
    public class myWebChromeClient extends WebChromeClient {
        ...
        public boolean onCreateWindow(WebView view, boolean dialog, boolean userGesture, Message resultMsg)
        {
            ...
            mWebView.setVisibility(getView().GONE);
            bottomlayout.setVisibility(getView().VISIBLE);
            customViewContainer.setVisibility(getView().VISIBLE);
        ...
        public void callAndroid_reg(final String memb, final String nick_n, final String change_a) {
            ...
            handler.post(new Runnable() {
                public void run() {
                    ...
                    Toast.makeText(getActivity().getApplicationContext(), R.string.syn,
