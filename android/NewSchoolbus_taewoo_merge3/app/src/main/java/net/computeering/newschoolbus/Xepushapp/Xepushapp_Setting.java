 ...
 */
public class Xepushapp_Setting extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		layout_sort = Xepushapp_QuickstartPreferences.layout_sort;
        URL_home = Xepushapp_QuickstartPreferences.URL_home;
        intent_back = getIntent();

        switch (layout_sort){
            case "1" : setContentView(R.layout.xepushapp_setting_main); break;
			case "2" : setContentView(R.layout.xepushapp_setting_main2); break;
			case "3" : setContentView(R.layout.xepushapp_setting_main3); break;
        }
        ...
        Log.i("Xepushapp_Setting", "boardset:"+boardset );
		...
		for(int i=0;i<array_board.length;i++){
			Log.i("Xepushapp_Setting", "array_board:"+array_board[i] );
        ...
        Log.i("Xepushapp_Setting", "registrationId:"+registrationId );
        ...
        if(!layout_sort.equals("3")) {
            if (prefs.contains("setting_board")) {
                ...
                Log.i("Xepushapp_Setting", "setting_board:" + setting_board_in);
        ...
        if(prefs.contains("setting"))
        {
			...
			if(prefs.contains("member_srl_origin")&&prefs.contains("nick_name_origin"))
			{
				...
				Log.i("Xepushapp_Setting",member_srl_origin+nick_name_origin+member_srl+nick_name );
	...
	private void sendSettingToServer() {
		...
		Log.i("Xepushapp_Setting", "setting:" + setting_send);
		Log.i("Xepushapp_Setting", "setting2:" + setting_send2);

		Intent intent_s = new Intent(this, Xepushapp_Sendserver.class);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            ctv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    view.toggle();
                    Log.i("Xepushapp_Setting", "isChecked?  " + view.isChecked() + "  position: " + pos);
                    if(view.isChecked()){
